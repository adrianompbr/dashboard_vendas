...
@st.cache_data
def converte_csv(df):
    return df.to_csv(index = False).encode('utf-8')#converter df para csv, não manter nome colunas e por formato utf8
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button("Fazer download tabela em csv",
